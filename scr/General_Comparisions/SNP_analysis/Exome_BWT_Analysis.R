...
setwd("/Users/salendrapradh/Documents/BWAvsBWT/individual_exomes_BWT/Variant_list/")
...
Reference_Exome_BWT_Summary =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Reference_Exome_BWT_Summary,"/Users/salendrapradh/WGS-and-WES/result/Reference_Exome_BWT_Summary.tsv",
...
Het_Exome_BWT_Summary =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Het_Exome_BWT_Summary,"/Users/salendrapradh/WGS-and-WES/result/Het_Exome_BWT_Summary.tsv",
            sep="\t", quote =F , row.names = F)
...
Mut_Exome_BWT_Summary =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Mut_Exome_BWT_Summary,"/Users/salendrapradh/WGS-and-WES/result/Mut_Exome_BWT_Summary.tsv",
            sep="\t", quote =F , row.names = F)
