...
setwd("/Users/salendrapradh/Documents/BWAvsBWT/WES_BWA/")
...
Summary_ExoVsExo_BWA =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Summary_ExoVsExo_BWA,"/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/Summary_ExoVsExo_BWA.tsv",
...
setwd("/Users/salendrapradh/Documents/BWAvsBWT/WES_BWT/")
...
Summary_ExoVSExo_BWT =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Summary_ExoVSExo_BWT,"/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/Summary_ExoVSExo_BWT.tsv",
            sep="\t", quote =F , row.names = F)
