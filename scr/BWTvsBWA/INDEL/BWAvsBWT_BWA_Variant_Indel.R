...
setwd("~/Desktop/New_analysis/INDEL_analysis/WES_BWTvsWES_BWA/WES_BWA/Variant_list_WES_BWA/")
...
Ref_ExoVsExo_BWA_Indel_Summary =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Ref_ExoVsExo_BWA_Indel_Summary,
            "/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/INDEL/Ref_ExoVsExo_BWA_Indel_Summary.tsv",
...
Het_ExoVsExo_BWA_indel_Summary =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Het_ExoVsExo_BWA_indel_Summary,
            "/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/INDEL/Het_ExoVsExo_BWA_indel_Summary.tsv",
            sep="\t", quote =F , row.names = F)
...
Homo_ExoVsExo_BWA_Indel_Summary =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Homo_ExoVsExo_BWA_Indel_Summary,
            "/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/INDEL/Homo_ExoVsExo_BWA_Indel_Summary.tsv",
            sep="\t", quote =F , row.names = F)
