...
setwd("~/Desktop/New_analysis/INDEL_analysis/WES_BWTvsWES_BWA/Both/")
...
Summary_Both_BWTvsBWA_indel = cbind (sample,number, mean_CD, mean_GQ, mean_MRR)
write.table(Summary_Both_BWTvsBWA_indel,"/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/INDEL/Summary_Both_BWTvsBWA_indel.tsv",
            sep="\t", quote =F , row.names = F)


################## Reference (0/0) Homo Analysis #############################
setwd("~/Desktop/New_analysis/INDEL_analysis/WES_BWTvsWES_BWA/Both/Con_Dis/")
...
Ref_Both_BWTvsBWA_Summary_indel = cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Ref_Both_BWTvsBWA_Summary_indel,
            "/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/INDEL/Ref_Both_BWTvsBWA_Summary_indel.tsv",
            sep="\t", quote =F , row.names = F)
...
Het_BothExoVsExo_Summary_indel =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Het_BothExoVsExo_Summary_indel,
            "/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/INDEL/Het_BothExoVsExo_Summary_indel.tsv",
            sep="\t", quote =F , row.names = F)
...
Homo_Both_ExoVsExo_Summary_indel=cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Homo_Both_ExoVsExo_Summary_indel,
            "/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/INDEL/Homo_Both_ExoVsExo_Summary_indel.tsv",
            sep="\t", quote =F , row.names = F)


##############Discordant Variant Analysis##############################
#######################################################################
## The idea for subdividing the discordant variants into true variants is such to find the condition we are interested in 
...
write.table(Summary_discordant,
            "/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/INDEL/Summary_discordant_Indel.tsv",
            sep="\t", quote =F , row.names = F)
