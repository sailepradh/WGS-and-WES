...
setwd("~/Desktop/New_analysis/INDEL_analysis/WES_BWTvsWES_BWA/WES_BWT/Variant_list_WES_BWT/")
...
Ref_ExoVSExo_BWT_Indel_Summary=cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Ref_ExoVSExo_BWT_Indel_Summary,
            "/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/INDEL/Ref_ExoVSExo_BWT_Indel_Summary.tsv",
...
Het_ExoVsExo_BWT_indel_summary =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Het_ExoVsExo_BWT_indel_summary ,
            "/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/INDEL/Het_ExoVsExo_BWT_indel_summary.tsv",
            sep="\t", quote =F , row.names = F)
...
Homo_ExoVSExo_BWT_Summary_indel =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Homo_ExoVSExo_BWT_Summary_indel,
            "/Users/salendrapradh/WGS-and-WES/result/BWAvsBWT/INDEL/Homo_ExoVSExo_BWT_Summary_indel.tsv",
            sep="\t", quote =F , row.names = F)
