...
setwd("~/Desktop/New_analysis/INDEL_analysis/WGS_WES/WES_BWA/")
...
Summary_Exo_GenExome_indel =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Summary_Exo_GenExome_indel,"/Users/salendrapradh/WGS-and-WES/result/GenvsExo/INDEL/Summary_Exo_GenExome_indel.tsv",
...
setwd("~/Desktop/New_analysis/INDEL_analysis/WGS_WES/WGS_BWA/")
...
Summary_Gen_GenvsExo_indel =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Summary_Gen_GenvsExo_indel,"/Users/salendrapradh/WGS-and-WES/result/GenvsExo/INDEL/Summary_Gen_GenvsExo_indel.tsv",
            sep="\t", quote =F , row.names = F)
