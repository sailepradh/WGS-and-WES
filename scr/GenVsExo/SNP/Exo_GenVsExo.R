...
setwd("/Users/salendrapradh/Documents/GenvsExo/WES_BWA/Variant_list_WES_BWA/")
...
Reference_Exo_GenvsExo_Summary =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Reference_Exo_GenvsExo_Summary,
            "/Users/salendrapradh/WGS-and-WES/result/GenvsExo/Reference_Exo_GenvsExo_Summary.tsv",
...
Het_Exo_GenVsExo_Summary =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Het_Exo_GenVsExo_Summary,
            "/Users/salendrapradh/WGS-and-WES/result/GenvsExo/Het_Exo_GenVsExo_Summary.tsv",
            sep="\t", quote =F , row.names = F)
...
Mut_Exo_GenVsExome_Summary =cbind(sample,number,mean_CD,mean_GQ,mean_MRR)
write.table(Mut_Exo_GenVsExome_Summary,"/Users/salendrapradh/WGS-and-WES/result/GenvsExo/Mut_Exo_GenVsExome_Summary.tsv",
            sep="\t", quote =F , row.names = F)
